...
# AGENT_BUFFER_MINUTES=30               # buffer minutes each side of a booking (Giggster + confirmed direct bookings; 0 disables)
# AGENT_REMINDER_HOUR_ET=18             # hour (NY, 24h) to email the night-before add-on prep reminder
